    ...
    public function edit(Vcard $vcard, Request $request)
{
    ...
    // 👇 Agregar esta línea para que funcione el menú de "emergency"
    $data['feature'] = $vcard->subscription->plan->planFeature ?? null;
    ...
    return view('vcards.edit', compact(
        'appointmentDetail', 'privacyPolicy', 'termCondition', 'iframes',
        'managesection', 'instagramEmbed', 'banners', 'dynamicVcard', 'customLink'
    ))->with($data);
}
