        ...
        <div class="row mt-7">
            ...
            <div class="row mb-5 plan-features">
                ...
                <div class="col-xxl-6 col-lg-12 col-md-4 col-6 mb-5 col-xs p-0">
                    ...
                    <input type="hidden" name="emergency_data" value="0">
                
                    <label class="form-label form-check p-0">
                        <input class="form-check-input feature mx-2" type="checkbox" value="1" name="emergency_data"
                            {{ isset($feature) && $feature->emergency_data == 1 ? 'checked' : '' }} />
                        Datos de Emergencia
                        <span data-bs-toggle="tooltip" data-placement="top"
                            data-bs-original-title="Permite a los usuarios ingresar tipo de sangre, alergias, contacto de emergencia y condiciones médicas">
                            <i class="fas fa-question-circle ml-1 general-question-mark"></i>
                        </span>
                    </label>
                </div>
